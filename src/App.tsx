...
function App() {
  ...
  const timeUnits = [
    ...
    { label: 'Minutes', value: timeLeft.minutes, icon: Target },
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
        ...
        {timeLeft.expired ? (
          <GlassPanel className="p-12 text-center reveal-item" style={{ animationDelay: '0.2s' }} tilt={false}>
            <Trophy className="w-20 h-20 text-[var(--c-gold)] mx-auto mb-6" />
            <h2 className="text-4xl font-bold text-[var(--c-text)] mb-4">The Day Has Arrived!</h2>
            <p className="text-xl text-[var(--c-text-dim)]">Best of luck on your exam!</p>
          </GlassPanel>
        ) : (
          <>
            <section className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6 mb-16 w-full max-w-5xl">
            ...
            <GlassPanel className="p-8 md:p-12 max-w-3xl w-full reveal-item" style={{ animationDelay: '0.6s' }}>
